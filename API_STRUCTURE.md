...
```json
{
  ...
  "backendUrl": "https://breavabackend.reliefy.doctor"
}
```
...
```json
{
  ...
  "camera_intrinsics": {
    // UWAGA: snake_case (ze względu na Python backend)
    "fx": 607.18,
    "fy": 606.77,
    "cx": 329.46,
    "cy": 242.86,
...
```
https://breavabackend.reliefy.doctor
```
...
3. Sprawdź czy dane są wysyłane do `https://breavabackend.reliefy.doctor`
